...
public class PaymentRequestCompletedDB {

    public static String TABLE_NAME = "PaymentRequestCompleted";
    ...
    public static List<PaymentRequest> getPaymentRequestCompleted (Cursor cursor){
        List<PaymentRequest> completedrequest = new ArrayList<>();
        if(cursor.getCount() > 0){
            while(cursor.moveToNext()){
                ...
                completedrequest.add(new PaymentRequest(
                        id,
                        datetimein,
                        datetimecompleted,
                        gktxnno,
