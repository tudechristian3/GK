...
public class CoopMiniSupportConversationDB {
    ///Table Name
    public static final String TABLE_COOP_SUPPORT_CONVERSATIONS = "table_coop_support_conversations";
    ...
    public static String CREATE_TABLE_COOP_SUPPORT_CONVERSATIONS = DBUtils.CT_IF_NOT_EXISTS + TABLE_COOP_SUPPORT_CONVERSATIONS + DBUtils.GENERIC_ID +
    ...
    private String TRUNCATE_TABLE = DBUtils.DELETE + TABLE_COOP_SUPPORT_CONVERSATIONS;
