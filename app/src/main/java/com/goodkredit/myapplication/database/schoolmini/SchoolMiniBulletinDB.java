...
public class SchoolMiniBulletinDB {
    //Table Name
    public static final String TABLE_SCHOOL_BULLETIN = "table_school_bulletin";
    ...
    public static String CREATE_TABLE_BULLETIN = DBUtils.CT_IF_NOT_EXISTS + TABLE_SCHOOL_BULLETIN + DBUtils.GENERIC_ID +
    ...
    private String TRUNCATE_TABLE = DBUtils.DELETE + TABLE_SCHOOL_BULLETIN;
    ...
    public static List<GenericBulletin> getSchoolMiniBulletin(Cursor cursor) {
        ...
        if (cursor.getCount() > 0) {
            while (cursor.moveToNext()) {
                ...
                schoolminibulletinlist.add(new GenericBulletin(id,
                        datetimein, title, description, imageurl, periodstart, periodend, addedby,
