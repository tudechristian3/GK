...
public class GKEarnPaymentAdapter extends RecyclerView.Adapter<GKEarnPaymentAdapter.MyViewHolder> {
    private Context mContext;
    private List<GKPaymentOptions> gkPaymentOptionsList;
    private ArrayList<GKPaymentOptions> passedgkPaymentOptionsList;
    private int mSelectedItem = -1;

    public GKEarnPaymentAdapter(Context context) {
        mContext = context;
    ...
    @Override
    public GKEarnPaymentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_gkearn_paymentoptions_item, parent, false);
    ...
    @Override
    public void onBindViewHolder(GKEarnPaymentAdapter.MyViewHolder holder, int position) {
        try {
    ...
    private View.OnClickListener itemSelectedListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try {
                final GKEarnPaymentAdapter.MyViewHolder holder = (MyViewHolder) v.getTag();
    ...
    private void addSelection(MyViewHolder holder) {
        if (passedgkPaymentOptionsList != null) {
            ...
            ((GKEarnPaymentOptionsActivity) mContext).selectPaymentOptions(passedgkPaymentOptionsList);
        }
    }
