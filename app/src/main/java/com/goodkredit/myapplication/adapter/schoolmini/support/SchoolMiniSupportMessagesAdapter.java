...
public class SchoolMiniSupportMessagesAdapter extends RecyclerView.Adapter<SchoolMiniSupportMessagesAdapter.MyViewHolder> {
    private Context mContext;
    private List<SupportConversation> mGridData;
    private static final int MY_MESSAGE = 0;
    private static final int OTHER_MESSAGE = 1;

    public SchoolMiniSupportMessagesAdapter(Context context) {
        mContext = context;
