...
public class CoopAssisantMemberProfileAdapter extends RecyclerView.Adapter<CoopAssisantMemberProfileAdapter.MyViewHolder> {
    private Context mContext;
    private List<CoopAssistantMembers> coopAssistantMembersList;
    private DatabaseHandler mdb;

    public CoopAssisantMemberProfileAdapter(Context context) {
        mContext = context;
    ...
    @Override
    public CoopAssisantMemberProfileAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(CoopAssisantMemberProfileAdapter.MyViewHolder holder, int position) {
        try {
            ...
            holder.main_itemscontainer.setBackground(ContextCompat.getDrawable(mContext, R.color.colorwhite));

            holder.imv_arrow_container.setVisibility(View.GONE);
