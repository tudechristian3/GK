...
public class ProjectCoopSupportThreadAdapter extends RecyclerView.Adapter<ProjectCoopSupportThreadAdapter.MyViewHolder> {
    private Context mContext;
    private List<SkycableSupportThread> mGridData;
    private boolean isOpen;
    private boolean isClose;

    public ProjectCoopSupportThreadAdapter(Context context) {
        mContext = context;
            ...
            if (position > -1) {
                ...
                switch (v.getId()) {
                    case R.id.linearThreadLayout: {
                        ...
                        ((ProjectCoopActivity) mContext).displayView(6, args);
                        break;
                    }
                }
