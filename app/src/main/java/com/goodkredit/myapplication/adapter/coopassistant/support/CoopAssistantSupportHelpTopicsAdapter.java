...
public class CoopAssistantSupportHelpTopicsAdapter extends RecyclerView.Adapter<CoopAssistantSupportHelpTopicsAdapter.MyViewHolder> {
    private Context mContext;
    private List<SupportHelpTopics> mGridData;

    public CoopAssistantSupportHelpTopicsAdapter(Context context) {
        mContext = context;
            ...
            if (position > -1) {
                ...
                switch (v.getId()) {
                    case R.id.linearSupportCaseLayout: {
                        ...
                        ((CoopAssistantHomeActivity) mContext).displayView(7, args);
