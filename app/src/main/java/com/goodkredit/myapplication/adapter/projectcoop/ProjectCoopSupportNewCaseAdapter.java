...
public class ProjectCoopSupportNewCaseAdapter extends RecyclerView.Adapter<ProjectCoopSupportNewCaseAdapter.MyViewHolder> {
    private Context mContext;
    private List<SkycableSupportHelpTopics> mGridData;

    public ProjectCoopSupportNewCaseAdapter(Context context) {
        mContext = context;
            ...
            if (position > -1) {
                ...
                switch (v.getId()) {
                    case R.id.linearSupportCaseLayout: {
                        ...
                        ((ProjectCoopActivity) mContext).displayView(7, args);
