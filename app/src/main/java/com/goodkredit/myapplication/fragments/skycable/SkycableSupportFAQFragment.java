...
import com.goodkredit.myapplication.adapter.skycable.SkycableSupportFAQAdapter;
...
public class SkycableSupportFAQFragment extends BaseFragment implements View.OnClickListener, ExpandableListView.OnGroupExpandListener {
...
//    private SwipeRefreshLayout mSwipeRefreshLayout;
    ...
    private SkycableSupportFAQAdapter mAdapter;
...
//        helptopic = skycableSupportHelpTopics.getHelpTopic();
    ...
    private void getSession() {
        if (CommonFunctions.getConnectivityStatus(getViewContext()) > 0) {
            ...
            mTvFetching.setText("Fetching Skycable FAQ's.");
...
//            call.enqueue(callsession);
            ...
            getSkycableSupportFAQ(getSkycableSupportFAQSession);
...
//    };
    ...
    private void getSkycableSupportFAQ(Callback<GetSkycableSupportFAQResponse> getSkycableSupportFAQCallback) {
        Call<GetSkycableSupportFAQResponse> getskycablesupportfaq = RetrofitBuild.getSkycableSupportFAQService(getViewContext())
                .getSkycableSupportFAQCall(sessionid,
                        imei,
                        userid,
                        borrowerid,
                        authcode,
    ...
    private final Callback<GetSkycableSupportFAQResponse> getSkycableSupportFAQSession = new Callback<GetSkycableSupportFAQResponse>() {
...
//            mSwipeRefreshLayout.setRefreshing(false);
            ...
            if (errorBody == null) {
                if (response.body().getStatus().equals("000")) {
                    ...
                    mAdapter = new SkycableSupportFAQAdapter(getViewContext(), expandableListTitle, expandableListDetail);
