...
import com.goodkredit.myapplication.adapter.skycable.SkycableSupportNewCaseAdapter;
import com.goodkredit.myapplication.adapter.skycable.SkycableSupportThreadAdapter;
...
public class SkycableSupportFragment extends BaseFragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private SkycableSupportThreadAdapter mAdapter;
...
//    private String sessionid;
    ...
    private SkycableSupportNewCaseAdapter mAdapterHelpTopic;
    ...
    private void init(View view) {
        ...
        mAdapter = new SkycableSupportThreadAdapter(getViewContext());
        ...
        mAdapterHelpTopic = new SkycableSupportNewCaseAdapter(getViewContext());
    ...
    private void getSession() {
        if (CommonFunctions.getConnectivityStatus(getViewContext()) > 0) {
            ...
            mTvFetching.setText("Fetching Skycable Support Threads.");
...
//    };
    ...
    private void getSkycableSupportThread(Callback<GetSkycableSupportThreadResponse> getSkycableSupportThreadCallback) {
        Call<GetSkycableSupportThreadResponse> getskycablesupportthread = RetrofitBuild.getSkycableSupportThreadService(getViewContext())
                .getSkycableSupportThreadCall(sessionid,
                        imei,
                        userid,
                        borrowerid,
                        authcode,
    ...
    private final Callback<GetSkycableSupportThreadResponse> getSkycableSupportThreadSession = new Callback<GetSkycableSupportThreadResponse>() {
