...
public class LinkSkycableAccountResponse {
    @SerializedName("data")
    @Expose
    private List<SkycableAccounts> skycableAccountsList = new ArrayList<>();
    @SerializedName("soa")
    @Expose
    ...
    public List<SkycableAccounts> getSkycableAccountsList() {
        return skycableAccountsList;
    }
