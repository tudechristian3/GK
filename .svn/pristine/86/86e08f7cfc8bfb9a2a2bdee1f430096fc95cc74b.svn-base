...
public class SchoolMiniConfig implements Parcelable {
    @SerializedName("ID")
    @Expose
    private int ID;
    ...
    public SchoolMiniConfig(int ID, String serviceCode, String serviceConfigCode, String serviceConfigName, String status, String extra1, String extra2, String notes1, String notes2) {
        this.ID = ID;
    ...
    protected SchoolMiniConfig(Parcel in) {
        ID = in.readInt();
    ...
    public static final Creator<SchoolMiniConfig> CREATOR = new Creator<SchoolMiniConfig>() {
        @Override
        public SchoolMiniConfig createFromParcel(Parcel in) {
            return new SchoolMiniConfig(in);
        }

        @Override
        public SchoolMiniConfig[] newArray(int size) {
            return new SchoolMiniConfig[size];
        }
    };
