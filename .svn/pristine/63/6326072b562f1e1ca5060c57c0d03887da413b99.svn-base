...
public class VotesHistory implements Parcelable {
    ...
    public VotesHistory(int ID, String dateTimeIN, String paymentTxnID, String billingID, String eventID, String merchantID, String borrowerID, String borrowerName, String borrowerMobileNumber, String participantID, String participantName, int numberOfVotes, double amount, double customerServiceCharge, double merchantServiceCharge, double resellerDiscount, double otherCharge, double totalAmount, String paymentDetails, String transactionMedium, String processID, String paymentType, String dateTimePaid, String partnerNetworkID, String partnerNetworkName, String partnerOutletID, String partnerOutletName, String preConsummationSession, String status, String extra1, String extra2, String extra3, String extra4, String notes1, String notes2, String eventName) {
        this.ID = ID;
    ...
    protected VotesHistory(Parcel in) {
        this.ID = in.readInt();
    ...
    public static final Creator<VotesHistory> CREATOR = new Creator<VotesHistory>() {
        @Override
        public VotesHistory createFromParcel(Parcel source) {
            return new VotesHistory(source);
        }

        @Override
        public VotesHistory[] newArray(int size) {
            return new VotesHistory[size];
        }
    };
}
