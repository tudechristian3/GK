...
public class SkycableSupportMessagesAdapter extends RecyclerView.Adapter<SkycableSupportMessagesAdapter.MyViewHolder> {
    private Context mContext;
    private List<SkycableConversation> mGridData;
    private static final int MY_MESSAGE = 0;
    private static final int OTHER_MESSAGE = 1;

    public SkycableSupportMessagesAdapter(Context context) {
        mContext = context;
